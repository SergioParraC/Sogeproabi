...
class SuppliesBaseModel(models.Model):
    ...
    data_aditional = models.CharField('Datos adicionales', max_length=50)
...
class RelationshipBaseModel(models.Model):
    ...
    date_edit = models.DateTimeField("Fecha y hora de modificación", auto_now=True, auto_now_add=True)
